...
# Исправленный список без путаницы языков и артефактов
phrases = [
    ...
    {"es": "Perdona, ¿me traes una caña, por favor?", "ru": "Извини, принесешь пива?", "file": "Perdona, me traes una caña, por favor_.m4a"},
    {"es": "Un café solo, por favor", "ru": "Черный кофе, пожалуйста", "file": "Un café solo, por favor.m4a"},
    {"es": "¿Me podrías traer la carta, por favor?", "ru": "Принесешь меню?", "file": "Me podrías traer la carta, por favor_.m4a"},
    ...
    {"es": "¿Cómo se dice en español...?", "ru": "Как сказать по-испански?", "file": "Como se dice en Eapañol.m4a"},
    {"es": "¿Podrías hablar más despacio, por favor?", "ru": "Можешь говорить помедленнее?", "file": "Podrías hablar más despacio, por favor.m4a"},
